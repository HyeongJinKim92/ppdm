...
extern paillier_pubkey_t* pub;
extern paillier_prvkey_t* prv;
...
typedef struct{ 	
	int node_id; 
	paillier_ciphertext_t** LL;	
	paillier_ciphertext_t** RR;	
	int NumData;
	int* indata_id;
}boundary;
...
//void	paillier_setkey(pubkey, prvkey);
...
void
paillier_subtract( paillier_pubkey_t* pub,
						 	paillier_ciphertext_t* res,
						 	paillier_ciphertext_t* ct0,
						 	paillier_ciphertext_t* ct1 );
...
/*
	...
	later result.
*/
paillier_ciphertext_t* paillier_create_enc_one();
paillier_ciphertext_t* paillier_create_enc_zero();
paillier_ciphertext_t* paillier_create_enc(int num);
